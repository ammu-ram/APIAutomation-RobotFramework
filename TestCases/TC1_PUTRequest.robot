...
put request_users
        ...
        ${response}=    PUT On Session  mysession   ${relative_url}     data={"name":"Ammu", "email":"xyx@gmail.com", "gender":"female", "status":"active"}     headers=${header}
        Log To Console    ${response.status_code}
        Log To Console    ${response.content}

#But the code is not working instead of post we have to use put on